...
services. Completion gets up to six CPUs and a 30-minute keep-alive; embedding
is capped at two CPUs and has two request slots so an article reindex cannot
